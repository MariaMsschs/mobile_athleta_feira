...
public class ListarEventosUseCase {
    ...
    public void listarEventos(String token, ListarEventosCallback callback, int pagina, int tamanho) {
        AthletaService service = RetrofitClientSql.getAthletaService();
        Call<EventoResponse> call = service.listarEventos(token, pagina, tamanho);
