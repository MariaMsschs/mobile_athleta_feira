...
public class ListarPostagensPorForumUseCase {
    ...
    public void listarPostagensPorForum(String forum, VerificarCallback callback, int pagina, int tamanho, String username) {
        AthletaService service = RetrofitClientMongo.getAthletaService();
        Call<List<Post>> call = service.listarPostagensPorForum(forum, pagina, tamanho);
