...
public class ListarPostagensPorIdUseCase {
    ...
    public void listarPostagensPorId(Long id, VerificarCallback callback, int pagina, int tamanho, String username) {
        AthletaService service = RetrofitClientMongo.getAthletaService();
        Call<List<Post>> call = service.listarPostagemPorId( pagina, tamanho, Integer.parseInt(String.valueOf(id)));
